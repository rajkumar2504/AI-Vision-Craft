...
const API_KEY = "API_KEY_HERE"; // Replace with your Hugging Face API key
...
const examplePrompts = [
  "A fluffy orange cat sleeping in a sunbeam",
  "A vibrant green apple with a single water droplet",
